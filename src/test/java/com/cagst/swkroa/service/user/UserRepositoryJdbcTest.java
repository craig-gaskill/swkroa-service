...
class UserRepositoryJdbcTest extends BaseTestRepository {
  ...
  class WhenGetUserByUsername {
    ...
    void testNotFound() {
      Optional<UserEntity> checkUser = repo.getUserByUsername("billybob");
    ...
    void testFound() {
      Optional<UserEntity> checkUser = repo.getUserByUsername("cgaskill");
    ...
    void testWillExpired() {
      Optional<UserEntity> checkUser = repo.getUserByUsername("temp");
      assertAll("Ensure the User",
          () -> assertNotNull(checkUser, "is valid"),
          () -> assertTrue(checkUser.isPresent(), "was found"),
    ...
    void testGetUserByUsername_Expired() {
      Optional<UserEntity> checkUser = repo.getUserByUsername("expire");
      assertAll("Ensure the User",
          () -> assertNotNull(checkUser, "is valid"),
          () -> assertTrue(checkUser.isPresent(), "was found"),
    ...
    void testGetUserByUsername_Locked() {
      Optional<UserEntity> checkUser = repo.getUserByUsername("locked");
      assertAll("Ensure the User",
          () -> assertNotNull(checkUser, "is valid"),
          () -> assertTrue(checkUser.isPresent(), "was found"),
  ...
  class WhenIncrementLoginAttempt {
    ...
    void testIncrementLoginAttempt() {
      Optional<UserEntity> checkUser1 = repo.getUserByUsername("cgaskill");
      assertTrue(checkUser1.isPresent(), "Ensure user was found.");

      UserEntity user1 = checkUser1.get();
      ...
      UserEntity user = repo.incrementLoginAttempts(user1);
      assertAll("Ensure the user",
      ...
      Optional<UserEntity> checkUser2 = repo.getUserByUsername("cgaskill");
      assertTrue(checkUser2.isPresent(), "Ensure user was found.");

      UserEntity user2 = checkUser2.get();
  ...
  class WhenLoginSuccessful {
    ...
    void testLoginSuccessful() {
      ...
      Optional<UserEntity> checkUser1 = repo.getUserByUsername("temp");
      assertTrue(checkUser1.isPresent(), "Ensure user was found.");
      ...
      UserEntity user = repo.loginSuccessful(user1, ipAddress);
      ...
      Optional<UserEntity> checkUser2 = repo.getUserByUsername("temp");
      assertTrue(checkUser2.isPresent(), "Ensure user was found.");
  ...
  class WhenLockAccount {
    ...
    void testLockUserAccount() {
      ...
      UserEntity user2 = repo.lockUserAccount(1, user1);
      assertNotNull(user2.lockedDateTime(), "Ensure user is valid.");

      Optional<UserEntity> checkUser3 = repo.getUserByUsername("cgaskill");
  ...
  class WhenUnlockAccount {
    ...
    void testUnlockUserAccount() {
      Optional<UserEntity> checkUser1 = repo.getUserByUsername("locked");
      assertTrue(checkUser1.isPresent(), "Ensure user was found.");

      UserEntity user1 = checkUser1.get();
      assertNotNull(user1.lockedDateTime(), "Ensure user account is locked.");

      UserEntity user2 = repo.unlockUserAccount(1, user1);
      assertNull(user2.lockedDateTime(), "Ensure user account is unlocked.");

      Optional<UserEntity> checkUser3 = repo.getUserByUsername("locked");
      assertAll("Ensure the user account",
          () -> assertNotNull(checkUser3, "is valid"),
          () -> assertTrue(checkUser3.isPresent(), "was found"),
